...
Alternatively, any of the following options may be used for those who prefer
not to use GitHub:

```{r gh-installation, eval = FALSE, collapse = TRUE}
...
```{r get_contributors-data, eval = TRUE, echo = FALSE}
dat <- data.frame (
    logins = c ("mpadge", "maelle", "shamindras", "assignUser"),
    contributions = c (176L, rep (NA_integer_, 3L)),
    avatar = c (
        "https://avatars.githubusercontent.com/u/6697851?v=4",
        "https://avatars.githubusercontent.com/u/8360597?u=824f03caa87c92420352e3dd9a05470320a67412&v=4",
        "https://avatars.githubusercontent.com/u/7627188?u=d05fb551796e6ce6db64ae43cd8ce48a0217ef85&v=4",
        "https://avatars.githubusercontent.com/u/16141871?u=bbf2ca4641e8ec034a9cdb583e62e3a94c372824&v=4"
    ),
    type = c ("code", rep ("issue_authors", 3L))
)
```
```{r get_contributors-fakey, eval = FALSE}
get_contributors (org = "ropensci", repo = "allcontributors")
```
```{r get_contributors-output, eval = TRUE, echo = FALSE}
cat (cli::col_green (cli::symbol$tick), " Extracted code contributors\n")
cat (cli::col_green (cli::symbol$tick), " Extracted github issue contributors\n")
cat (cli::col_green (cli::symbol$tick), " Downloaded GitHub URLs\n")
print (dat)
```
...
The function does not need to be exported, and should return a single text item
(which you can modify to suit your own needs). That function will then be read
by  `usethis` and the text within it automatically added to the checklist items
